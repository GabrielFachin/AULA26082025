...
ALTER TABLE T_TESTE_DDL ADD CONSTRAINT PK_TEST_DDL PRIMARY KEY (CD_TESTE);

ALTER TABLE T_TESTE_DDL ADD CONSTRAINT UN_TESTE_DDL_NOME UNIQUE(NM_TESTE);

ALTER TABLE T_TESTE_DLL ADD CONSTRAINT UN_TEST_DDL_DESC UNIQUE (DS_TESTE);

ALTER TABLE T_TESTE_DDL ADD DS_EMAIL VARCHAR2(80);

ALTER TABLE T_TESTE_DDL ADD (DS_OBS1 VARCHAR2(50) 
NOT NULL, DS_OBS2 VARCHAR2(50));

ALTER TABLE T_TESTE_DDL MODIFY (DS_OBS VARCHAR2(80));
...
ALTER TABLE T_TESTE_DDL DROP CONSTRAINT PK_TEST_DDL;
